...
/**
 * TS port of ``populis_puzzles.mint_publish_driver.build_mint_publish_artifacts``.
 *
 ...
 * is generated by
 * ``populis_protocol/scripts/dump_mint_publish_fixtures.py`` and read by
 ...
 * in ``populis_protocol/tests/test_mint_publish_fixtures.py``.
 *
 ...
 *     for Artifact A, tracker.PROPOSE for Artifact B, PGT lock for the
