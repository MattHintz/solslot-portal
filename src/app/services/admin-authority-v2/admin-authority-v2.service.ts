 ...
 * ``solslot_protocol/solslot_puzzles/admin_authority_v2_driver.py``.
 *
 ...
 * the Solslot API.  This service is the canonical client-side
 ...
 * ``solslot_protocol/scripts/dump_v2_fixtures.py`` and pinned by the
...
export class AdminAuthorityV2Service {
  ...
  static readonly DEFAULTS = {
    ...
    sgtGovernancePuzzleHash: '0x' + '00'.repeat(32),
  } as const;
   ...
   * singleton emits as ``CREATE_PUZZLE_ANNOUNCEMENT(0x53 || state_hash)``
  ...
  makeInnerPuzzleHash(args: {
    ...
    sgtGovernancePuzzleHash?: string;
  }): Uint8Array {
    ...
    const curried = puzzle.curry([
      ...
      clvm.atom(
        hexToBytes(args.sgtGovernancePuzzleHash ?? D.sgtGovernancePuzzleHash),
      ),
      clvm.atom(hexToBytes(args.mipsRootHash)),
      clvm.atom(hexToBytes(args.adminsHash)),
   ...
   * ``solslot_protocol/tests/test_admin_authority_v2_launch.py``.
   *
   ...
   *
   * Mirrors ``solslot_protocol.solslot_puzzles.admin_authority_v2_driver.compute_launch_outputs``
